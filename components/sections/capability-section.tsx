...
import { CapabilityRowProvider } from "@/components/sections/capability-row-context"
 ...
 *
 * A server component: the accordion, the panel, and the row provider that couples them are the
 * client boundaries, and all three are imported, not authored here. The provider wraps both
 * columns because the panel illustrates whichever row is open (§5.2) — one piece of state, held
 * above both, so neither column owns the other.
 *
